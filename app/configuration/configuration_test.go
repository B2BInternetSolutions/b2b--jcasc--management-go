...
func assertJenkinsConfig(conf *config, t *testing.T) {
	...
	assert.Equal(t, conf.Jenkins.Jcasc.ConfigurationURL, "https://raw.githubusercontent.com/B2BInternetSolutions/b2b--jcasc--management-go/main/projects/{{ .Base.Namespace }}/jcasc_config.yaml")
	...
	assert.Equal(t, conf.Jenkins.Jcasc.SeedJobURL, "https://github.com/B2BInternetSolutions/jenkins-jobdsl-remote.git")
